          ...
          <View style={styles.glassCard}>
            ...
            {mode === 'login' && (
              <>
                ...
                {/* ── Quick Demo Login Shortcuts for Owner & Roles ── */}
                <View style={{ marginTop: 14, marginBottom: 14 }}>
                  <Text style={{ fontSize: 11, fontWeight: '700', color: 'rgba(255,255,255,0.5)', textAlign: 'center', marginBottom: 10, letterSpacing: 0.5 }}>
                    QUICK 1-TAP ROLE LOGIN
                  </Text>
                  <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, justifyContent: 'center' }}>
                    <TouchableOpacity
                      style={{ backgroundColor: 'rgba(108, 92, 231, 0.25)', borderColor: '#6C5CE7', borderWidth: 1, borderRadius: 10, paddingVertical: 6, paddingHorizontal: 12 }}
                      onPress={() => {
                        setMobileNumber('9326093115');
                        setPassword('Hello@123');
                        login('9326093115', 'Hello@123');
                      }}
                    >
                      <Text style={{ color: '#A29BFE', fontSize: 11.5, fontWeight: '700' }}>👑 FNS Owner</Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                      style={{ backgroundColor: 'rgba(0, 194, 255, 0.20)', borderColor: '#00C2FF', borderWidth: 1, borderRadius: 10, paddingVertical: 6, paddingHorizontal: 12 }}
                      onPress={() => {
                        setMobileNumber('9999999997');
                        setPassword('Hello@123');
                        login('9999999997', 'Hello@123');
                      }}
                    >
                      <Text style={{ color: '#38BDF8', fontSize: 11.5, fontWeight: '700' }}>🏢 Desire Owner</Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                      style={{ backgroundColor: 'rgba(0, 196, 140, 0.20)', borderColor: '#00C48C', borderWidth: 1, borderRadius: 10, paddingVertical: 6, paddingHorizontal: 12 }}
                      onPress={() => {
                        setMobileNumber('9209282289');
                        setPassword('Hello@123');
                        login('9209282289', 'Hello@123');
                      }}
                    >
                      <Text style={{ color: '#00C48C', fontSize: 11.5, fontWeight: '700' }}>🏋️ Member</Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                      style={{ backgroundColor: 'rgba(255, 153, 0, 0.20)', borderColor: '#FF9900', borderWidth: 1, borderRadius: 10, paddingVertical: 6, paddingHorizontal: 12 }}
                      onPress={() => {
                        setMobileNumber('9870000001');
                        setPassword('Hello@123');
                        login('9870000001', 'Hello@123');
                      }}
                    >
                      <Text style={{ color: '#FF9900', fontSize: 11.5, fontWeight: '700' }}>⚡ Trainer</Text>
                    </TouchableOpacity>
                  </View>
                </View>
