...
export const GYMS: Gym[] = [
  {
    ...
    tagline: 'Nagpur\'s Premier Fitness Hub',
    rating: 4.8,
    address: '2nd floor, Guatam Traders, Besa Rd, Nagpur',
  ...
  },
  {
    ...
    rating: 4.7,
    address: 'Manewada Rd, Manewada Chowk, Nagpur',
    city: 'Nagpur, Maharashtra',
    phone: '9999999998',
  ...
  },
  {
    ...
    tagline: 'Your Fitness, Our Desire',
    rating: 4.9,
    address: '11, Chandra Nagar Rd, Hawarapeth, Nagpur',
    city: 'Nagpur, Maharashtra',
    phone: '9999999997',
  ...
  {
    id: 'g4',
    name: 'Suraj wanjari Unisex Gym',
    tagline: 'Personalized Unisex Fitness',
    rating: 4.5,
    address: 'Kamal Chowk, Nagpur',
    city: 'Nagpur, Maharashtra',
    phone: '9999999996',
...
export const WORKOUT_PLANS: WorkoutPlan[] = [
  {
    ...
    trainerId: 't1',
    memberId: 'm1',
    name: 'Weekly Gym Exercise Schedule',
    goal: 'general_fitness',
    days: [
      {
        day: 'Monday',
        focus: 'Chest & Triceps',
        exercises: [
          { id: 'm_e1', name: 'Bench Press', muscleGroup: 'Chest', sets: 4, reps: '12', weight: 'Bar + 20kg', restSeconds: 90, videoUrl: '', isDone: false },
          { id: 'm_e2', name: 'Incline Dumbbell Press', muscleGroup: 'Chest', sets: 4, reps: '12', weight: '15kg', restSeconds: 75, videoUrl: '', isDone: false },
          { id: 'm_e3', name: 'Dumbbell Fly', muscleGroup: 'Chest', sets: 3, reps: '15', weight: '10kg', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'm_e4', name: 'Push-Ups', muscleGroup: 'Chest', sets: 3, reps: '20', weight: 'Bodyweight', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'm_e5', name: 'Tricep Pushdown', muscleGroup: 'Triceps', sets: 4, reps: '12', weight: '20kg', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'm_e6', name: 'Overhead Tricep Extension', muscleGroup: 'Triceps', sets: 3, reps: '15', weight: '12.5kg', restSeconds: 75, videoUrl: '', isDone: false },
          { id: 'm_e7', name: 'Bench Dips', muscleGroup: 'Triceps', sets: 3, reps: '15', weight: 'Bodyweight', restSeconds: 60, videoUrl: '', isDone: false },
        ],
      },
      {
        day: 'Tuesday',
        focus: 'Back & Biceps',
        exercises: [
          { id: 't_e1', name: 'Lat Pulldown', muscleGroup: 'Back', sets: 4, reps: '12', weight: '45kg', restSeconds: 75, videoUrl: '', isDone: false },
          { id: 't_e2', name: 'Seated Cable Row', muscleGroup: 'Back', sets: 4, reps: '12', weight: '40kg', restSeconds: 75, videoUrl: '', isDone: false },
          { id: 't_e3', name: 'Deadlift', muscleGroup: 'Back', sets: 4, reps: '10', weight: '70kg', restSeconds: 120, videoUrl: '', isDone: false },
          { id: 't_e4', name: 'One Arm Dumbbell Row', muscleGroup: 'Back', sets: 3, reps: '12', weight: '17.5kg', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 't_e5', name: 'Barbell Curl', muscleGroup: 'Biceps', sets: 4, reps: '12', weight: '20kg', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 't_e6', name: 'Hammer Curl', muscleGroup: 'Biceps', sets: 3, reps: '15', weight: '10kg', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 't_e7', name: 'Concentration Curl', muscleGroup: 'Biceps', sets: 3, reps: '12', weight: '7.5kg', restSeconds: 60, videoUrl: '', isDone: false },
        ],
      },
      {
        day: 'Wednesday',
        focus: 'Legs',
        exercises: [
          { id: 'w_e1', name: 'Squats', muscleGroup: 'Legs', sets: 4, reps: '15', weight: '50kg', restSeconds: 120, videoUrl: '', isDone: false },
          { id: 'w_e2', name: 'Leg Press', muscleGroup: 'Legs', sets: 4, reps: '15', weight: '120kg', restSeconds: 90, videoUrl: '', isDone: false },
          { id: 'w_e3', name: 'Walking Lunges', muscleGroup: 'Legs', sets: 3, reps: '20 Steps', weight: 'Bodyweight', restSeconds: 75, videoUrl: '', isDone: false },
          { id: 'w_e4', name: 'Leg Extension', muscleGroup: 'Legs', sets: 3, reps: '15', weight: '30kg', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'w_e5', name: 'Leg Curl', muscleGroup: 'Legs', sets: 3, reps: '15', weight: '25kg', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'w_e6', name: 'Standing Calf Raise', muscleGroup: 'Legs', sets: 4, reps: '20', weight: 'Bodyweight', restSeconds: 45, videoUrl: '', isDone: false },
        ],
      },
      {
        day: 'Thursday',
        focus: 'Shoulders & Abs',
        exercises: [
          { id: 'th_e1', name: 'Shoulder Press', muscleGroup: 'Shoulders', sets: 4, reps: '12', weight: '15kg dbs', restSeconds: 90, videoUrl: '', isDone: false },
          { id: 'th_e2', name: 'Lateral Raise', muscleGroup: 'Shoulders', sets: 3, reps: '15', weight: '7.5kg dbs', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'th_e3', name: 'Front Raise', muscleGroup: 'Shoulders', sets: 3, reps: '15', weight: '7.5kg dbs', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'th_e4', name: 'Rear Delt Fly', muscleGroup: 'Shoulders', sets: 3, reps: '15', weight: '5kg dbs', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'th_e5', name: 'Crunches', muscleGroup: 'Abs', sets: 3, reps: '25', weight: 'Bodyweight', restSeconds: 45, videoUrl: '', isDone: false },
          { id: 'th_e6', name: 'Plank', muscleGroup: 'Abs', sets: 3, reps: '60 sec', weight: 'Bodyweight', restSeconds: 45, videoUrl: '', isDone: false },
          { id: 'th_e7', name: 'Leg Raises', muscleGroup: 'Abs', sets: 3, reps: '20', weight: 'Bodyweight', restSeconds: 45, videoUrl: '', isDone: false },
          { id: 'th_e8', name: 'Russian Twist', muscleGroup: 'Abs', sets: 3, reps: '20', weight: 'Bodyweight', restSeconds: 45, videoUrl: '', isDone: false },
        ],
      },
      {
        day: 'Friday',
        ...
        exercises: [
          { id: 'f_e1', name: 'Burpees', muscleGroup: 'Full Body', sets: 3, reps: '15', weight: 'Bodyweight', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'f_e2', name: 'Push-Ups', muscleGroup: 'Full Body', sets: 3, reps: '20', weight: 'Bodyweight', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'f_e3', name: 'Pull-Ups', muscleGroup: 'Full Body', sets: 3, reps: '10', weight: 'Bodyweight', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'f_e4', name: 'Kettlebell Swing', muscleGroup: 'Full Body', sets: 3, reps: '15', weight: '16kg', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 'f_e5', name: 'Mountain Climbers', muscleGroup: 'Full Body', sets: 3, reps: '30 sec', weight: 'Bodyweight', restSeconds: 45, videoUrl: '', isDone: false },
          { id: 'f_e6', name: 'Jump Rope', muscleGroup: 'Full Body', sets: 1, reps: '10 mins', weight: 'Bodyweight', restSeconds: 120, videoUrl: '', isDone: false },
        ],
      },
      {
        day: 'Saturday',
        ...
        exercises: [
          { id: 's_e1', name: 'Treadmill Running', muscleGroup: 'Cardio', sets: 1, reps: '20 mins', weight: 'Bodyweight', restSeconds: 0, videoUrl: '', isDone: false },
          { id: 's_e2', name: 'Cycling', muscleGroup: 'Cardio', sets: 1, reps: '15 mins', weight: 'Bodyweight', restSeconds: 0, videoUrl: '', isDone: false },
          { id: 's_e3', name: 'Battle Rope', muscleGroup: 'Functional', sets: 3, reps: '30 sec', weight: 'Bodyweight', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 's_e4', name: 'Box Jump', muscleGroup: 'Functional', sets: 3, reps: '15', weight: 'Bodyweight', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 's_e5', name: 'Jump Squats', muscleGroup: 'Functional', sets: 3, reps: '20', weight: 'Bodyweight', restSeconds: 60, videoUrl: '', isDone: false },
          { id: 's_e6', name: 'Stretching & Cool Down', muscleGroup: 'Recovery', sets: 1, reps: '15 mins', weight: 'Bodyweight', restSeconds: 0, videoUrl: '', isDone: false },
        ],
      },
      {
        day: 'Sunday',
...
export function getWorkoutPlanByMember(memberId: string): WorkoutPlan | undefined {
  return WORKOUT_PLANS.find(w => w.memberId === memberId) || WORKOUT_PLANS[0];
}
